...
<head>
    ...
    *
    */
   	require_once '../nichtinzip/passwd.inc.php'; /*Das ist scheisse. Muss unbedingt mit git-ignore versehen werden, damit es nicht in github landet.*/
   	require_once('DB.php');
   	 ...
   	 */
   	$dbh = new DB('_s0563968__mockupdatadb', 'db.f4.htw-berlin.de:3306', 's0563968', $password);
...
<body>
    ...
    // $dbh->delete(58);
    // $dbh->edit(array("Jan", "Justermann", "jan@ustermann.de", "5678", 59));
